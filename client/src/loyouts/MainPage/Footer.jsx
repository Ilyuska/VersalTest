    ...
    <div className="p-5 bg-neutral-900 flex text-white flex-col md:flex-row ">
      ...
      <div className="flex justify-around md:w-7/12 ">
        <div className="flex flex-col  md:w-2/3">
          ...
          <Link to="/menu" className="md:mr-3 mb-1 md:mb-2">
            Заказать банкет
          </Link>
          <Link to="/projects" className="md:mr-3 mb-1 md:mb-2">
            Наши проекты
          </Link>
          <Link to="/trusts" className="md:mr-3 mb-1 md:mb-2">
            Нам доверяют
          </Link>
          <Link to="/contacts" className="md:mr-3 mb-1 md:mb-2">
            Контакты
          </Link>
        </div>
